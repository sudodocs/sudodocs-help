...
`--role` is `Writer` or `System Administrator`. Blocked with an error if your organization is already at its seat limit - see [Invite a Team Member](../../saas-guide/admin/users.md#invite-a-team-member).
