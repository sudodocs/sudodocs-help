...
CLI equivalent of [Admin Tasks → Security & SSO](../admin-guide/sso-setup.md). Admin-only, and Enterprise-only - the same plan restriction the SSO tab enforces.
...
Set your IdP's **Sign-in Redirect URI** to `https://app.sudodocs.com/login/sso/callback` before saving - see [Configure your Identity Provider](../admin-guide/sso-setup.md#configure-your-identity-provider-idp).
