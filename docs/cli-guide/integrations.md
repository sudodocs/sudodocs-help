...
CLI equivalents of [Admin Tasks → Connect Services](../admin-guide/integrations.md). Admin-only, same as the Services tab.
...
`--jira-token` is an Atlassian API Token, not your password - see [Connect Jira](../admin-guide/integrations.md#connect-jira).
